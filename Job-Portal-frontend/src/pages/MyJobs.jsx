      ...
      if (err.response?.status === 401 || err.response?.status === 403) {
        ...
        setError(
          err.response?.data?.message ||
            "Could not load your jobs. Please try again later."
        );
      }
    } finally {
      setLoading(false);
            ...
            <div key={job._id} className="job-card-simple">
              ...
              <div className="job-info">
                ...
                <p className="assessment-info">
                  🧠 Assessment:{" "}
                  {job.hasAssessment
                    ? `Enabled (${job.assessmentDuration} min | Pass ${job.assessmentPassingScore}%)`
                    : "Not Enabled"}
                </p>
                ...
                <p className="interview-info">
                  🎤 Interview: {job.interviewRequired ? "Required" : "Not Required"}
                </p>
              ...
              <div className="job-actions">
                ...
                <button
                  className="edit-btn"
                  onClick={() =>
                    navigate("/employer/post-job", { state: { editJob: job } })
                  }
                >
                  Edit
                </button>
                ...
                {job.hasAssessment && (
                  <button
                    ...
                    onClick={() =>
                      navigate(`/assessment-upload/${job._id}`)
                    }
                  >
                    Manage Assessment
                  </button>
